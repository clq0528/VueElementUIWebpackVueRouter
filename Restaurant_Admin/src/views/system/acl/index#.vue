  ...
  <div class="main-wrap">
      ...
      <div class="right-bar">
        <el-form :inline="true" :model="searchData" ref="searchData">
          <el-form-item prop="aclName">
            <el-input v-model="searchData.aclName" placeholder="资源名称" @change="getSearchList" @keyup.enter.native="getSearchList"></el-input>
          </el-form-item>
          <el-form-item prop="aclType">
            <el-select v-model="searchData.aclType" placeholder="资源类型" clearable @change="getSearchList">
          ...
          <el-form-item prop="aclStatus">
            <el-select v-model="searchData.aclStatus" placeholder="资源状态" clearable @change="getSearchList">
    ...
    <div class="table-wrap" v-loading="loading">
      ...
      <el-table :data="tableData" ref="tableData" height="100%" fit v-show="!loading">
        ...
        <el-table-column label="资源编号" prop="aclCode" show-overflow-tooltip align="center"></el-table-column>
...
export default {
  ...
  data () {
    return {
      loading: true,
      searchData: {
        aclName: this.$route.query.aclName || null,
        aclType: this.$route.query.aclType || null,
        aclStatus: this.$route.query.aclStatus || null
      },
      tableData: [],
