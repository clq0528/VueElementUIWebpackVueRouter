  ...
  <div class="main-wrap">
      ...
      <div class="right-bar">
        <el-form :inline="true" :model="searchData" ref="searchData">
          <el-form-item prop="name">
            <el-input v-model="searchData.name" placeholder="分类名称" @change="pageChangeList" @keyup.enter.native="pageChangeList"></el-input>
          </el-form-item>
          <el-form-item prop="status">
            <el-select v-model="searchData.status" placeholder="分类状态" clearable @change="pageChangeList">
    ...
    <div class="table-wrap">
      ...
      <el-table :data="tableData" ref="tableData" height="100%" fit v-loading="loading">
        ...
        <el-table-column label="分类名称" prop="name" show-overflow-tooltip align="center"></el-table-column>
        <el-table-column label="分类描述" prop="description" show-overflow-tooltip align="center">
...
import { getFoodCategoryList, deleteFoodCategoryItem } from '@/api/food'
  ...
  methods: {
    ...
    delItem (id) {
      ...
      this.$confirm('是否删除该信息？', '提示', {
        ...
        deleteFoodCategoryItem(id).then(() => {
          this.getList()
