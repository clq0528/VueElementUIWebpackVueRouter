  ...
  <div class="main-wrap">
      ...
      <div class="right-bar">
        <el-form :inline="true" :model="searchData" ref="searchData">
          <el-form-item prop="name">
            <el-input v-model="searchData.name" placeholder="规格类型" @change="pageChangeList" @keyup.enter.native="pageChangeList"></el-input>
          </el-form-item>
    ...
    <div class="table-wrap">
      ...
      <el-table :data="tableData" ref="tableData" height="100%" fit v-loading="loading">
        ...
        <el-table-column label="规格类型" prop="name" show-overflow-tooltip></el-table-column>
        <el-table-column label="价格状态" prop="priceStatus" align="center">
          <template slot-scope="scope">
            <el-tag type="success" v-if="scope.row.priceStatus === 'Y'">已启用</el-tag>
            <el-tag type="danger" v-if="scope.row.priceStatus === 'N'">已停用</el-tag>
          </template>
        </el-table-column>
...
import { getFoodSpecCategoryList, deleteFoodSpecCategoryItem } from '@/api/food'
  ...
  methods: {
    ...
    delItem (id) {
      ...
      this.$confirm('是否删除该信息？', '提示', {
        ...
        deleteFoodSpecCategoryItem(id).then(() => {
          this.getList()
