  ...
  <div class="main-wrap">
      ...
      <div class="right-bar">
        <el-form :inline="true" :model="searchData" ref="searchData">
          <el-form-item prop="name">
            <el-input v-model="searchData.name" placeholder="标题名称" @change="pageChangeList" @keyup.enter.native="pageChangeList"></el-input>
          </el-form-item>
    ...
    <div class="table-wrap">
      ...
      <el-table :data="tableData" ref="tableData" height="100%" fit v-loading="loading">
        ...
        <el-table-column label="图片" width="100" prop="path" align="center">
          <template slot-scope="scope">
            <img class="zoom-img__simg" :src="scope.row.path" @click="zoomImage(scope.row.path)">
          </template>
        </el-table-column>
        <el-table-column label="标题名称" prop="name" show-overflow-tooltip align="center"></el-table-column>
        ...
        <el-table-column label="操作" width="220" align="center">
          <template slot-scope="scope">
            <el-button type="text" icon="el-icon-zoom-in" plain @click="openWindow('detail', scope.row)">查看</el-button>
